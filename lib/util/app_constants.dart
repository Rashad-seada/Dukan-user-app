...
import 'package:dukan_user_app/common/models/choose_us_model.dart';
...
class AppConstants {
  static const String appName = 'Dukan';
  static const double appVersion = 2.12; ///Flutter Version: 3.24.5

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://el-dukan.shop';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://el-dukan.shop';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.kurdistane,languageName: 'Kurdi',countryCode: 'KU',languageCode:'ku' ),
